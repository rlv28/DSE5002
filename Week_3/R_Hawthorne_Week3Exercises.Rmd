...
#[1] 5 2
```
The shorter version of the code saves half the steps! So unless you needed the code to check each pair of indices written both in ascending and descending order, I can use the shorter code to save work.
